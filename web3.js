...
exports.getBalances = async (contractAddress, fromBlock) => {
    // TODO: Replace this with our ERC20 ABI
    ...
    // TODO: Replace this hardcoded address with the param being passed in
    ...
    const contract = new web3.eth.Contract(BASE_ERC20.abi, contractAddress);
    //balances dict
    let balances = {};
    ...
    const events = await contract.getPastEvents(
        'Transfer', 
        {
            fromBlock:  fromBlock, // fromBlock should be the block when the erc-20 contract was deployed
            toBLock: 'latest'
        }
    ); //note: this fromBlock, toBlock filter is likely unecessary for our purposes (since we want all transfers)
